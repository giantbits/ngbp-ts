module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    ts: {
        options: {                    // use to override the default options, See : http://gruntjs.com/configuring-tasks#options
            ...
            declaration: false,       // true | false  (default)x
        ...
        build: {                                    // a particular target
            ...
            html: [ '<%= app_files.tshtml %>' ],    // The source html files, https://github.com/basarat/grunt-ts#html-2-typescript-support
  ...
  grunt.registerTask( 'tsdrefresh', ['tsd:refresh']);

  /**
   * The `build` task gets your app ready to run for development and testing.
   */
  grunt.registerTask( 'build', [
    'clean', 'ts:build', 'html2js', 'jshint', 'coffeelint', 'coffee', 'less:build',
